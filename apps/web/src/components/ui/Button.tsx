...
export function Button({
  ...
  const classes = cn(
    "inline-flex items-center justify-center rounded-full font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-lumeria-sage/50",
    variants[variant],
    sizes[size],
    className,
  );
