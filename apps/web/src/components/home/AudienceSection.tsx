  ...
  return (
    <section className="relative py-32">
      ...
      <div className="relative mx-auto max-w-6xl px-6">
        ...
        >
          <p className="text-2xl font-medium leading-relaxed text-lumeria-white md:text-3xl">
            {HOME_AUDIENCE.intro}
          </p>
        </motion.div>
        ...
        <motion.div
          ...
          className="mt-16 rounded-2xl glass-panel p-8 md:p-12"
        >
        ...
        <div className="mt-12 grid gap-8 md:grid-cols-2">
          <motion.div
            ...
            className="rounded-2xl border border-lumeria-leaf/20 bg-lumeria-leaf/5 p-8"
          >
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
            className="rounded-2xl border border-lumeria-sage/10 p-8"
          >
